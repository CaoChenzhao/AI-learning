...
class TrainALL(tune.Trainable):
    ...
    def setup(self, config):
        ...
        self.CASED = 'C:/Users/14/Desktop/Reproduction_of_MCAN-main/bert-base-multilingual-cased/'  # multilingual-cased
        self.VOCAB = 'C:/Users/14/Desktop/Reproduction_of_MCAN-main/bert-base-multilingual-cased/vocab.txt'
        self.pthfile = 'C:/Users/14/Desktop/Reproduction_of_MCAN-main/vgg19-dcbb9e9d.pth'
    ...
    def train_one_time(self):
        ...
        for epoch_index in tqdm(range(self.epochs), desc='Epochs'):
            ...
            train_batch_loss = []
            train_batch_acc = []
            for train_data in tqdm(self.train_loader, desc='Training', leave=False):
            ...
            for test_data in tqdm(self.test_loader, desc='Testing', leave=False):
    ...
    def print_result_table_handler(self, loss_values, acc_values,
        ...
        # 这个地方需要绝对路径，不能使用相对路径
        if not os.path.exists('C:/Users/14/Desktop/Reproduction_of_MCAN-main/results'):
            os.makedirs('C:/Users/14/Desktop/Reproduction_of_MCAN-main/results')
        f_result = open(
            'C:/Users/14/Desktop/Reproduction_of_MCAN-main/results/{}_accuracy.txt'.format(
                self.dataset_name), 'a+')
...
if __name__ == '__main__':
    ...
    local_dir = os.path.join(local_dir_root)
